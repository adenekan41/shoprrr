            ...
            <div className="sign-in-and-sign-up">
                <div>
                    ...
                    <div className="routes">
                        <Link to="/auth" className={props.location.pathname === "/auth" && 'activetab'}>Login</Link>
                        <Link to="/auth/signup" className={props.location.pathname === "/auth/signup" && 'activetab'}>Register</Link>
                    </div>
